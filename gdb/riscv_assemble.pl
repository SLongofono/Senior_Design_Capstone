...
{
    my @disasm = `/home/babypaw/riscv/riscv/bin/riscv64-unknown-linux-gnu-objdump -d /home/babypaw/riscv/gdb/new_test.o`;
...
sub add_instruction_to_file
{
    ...
    open my $old_fh, '<:raw', '/home/babypaw/riscv/gdb/test.o';
    open my $new_fh, '>:raw', '/home/babypaw/riscv/gdb/new_test.o';
